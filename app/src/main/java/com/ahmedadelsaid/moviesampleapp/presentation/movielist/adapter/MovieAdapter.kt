...
import com.ahmedadelsaid.moviesampleapp.presentation.NetworkStateViewHolder

class MovieAdapter(private val retryCallback: () -> Unit) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback) {

    private var networkState: NetworkState? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            R.layout.movie_list_item -> MovieViewHolder.create(parent)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when (getItemViewType(position)) {
            R.layout.movie_list_item -> (holder as MovieViewHolder).bindTo(getItem(position))
